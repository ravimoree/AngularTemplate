...
function loadFileData(datas) {
    ...
    Array.from(datas).forEach(function (element, index) {
        ...
        employeeTable.add({
            ...
            Name: `<a href="javascript:void(0);" class="flex items-center gap-3">
    ...
    employeeTable.remove("ID", `<a href="javascript:void(0);" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">#TWE1001501</a>`);
...
function refreshCallbacks() {
    ...
    Array.from(document.querySelectorAll(".remove-item-btn")).forEach(function (btn) {
        btn.addEventListener("click", function (e) {
            ...
            var itemValues = employeeTable.get({
                id: `<a href="javascript:void(0);" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">` + removeitemId + `</a>`,
            });
            Array.from(itemValues).forEach(function (x) {
...
Array.prototype.slice.call(forms).forEach(function (form) {
    form.addEventListener('submit', function (event) {
        ...
        if (!editList && allFieldsValid) {
            ...
            employeeTable.add({
                id: count,
                ID: `<a href="javascript:void(0);" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600"> ` + employeeId.value + `</a>`,
                Name: `<a href="javascript:void(0);" class="flex items-center gap-3">
