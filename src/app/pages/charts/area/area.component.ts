...
export class AreaComponent {
   ...
   ngOnInit(): void {
     ...
     this._basicAreaChart('["bg-custom-500"]');
     this._splineAreaChart('["bg-custom-500", "bg-green-500"]');
     this._datetimeXaxisChart('["bg-custom-500"]');
     this._nagativeValueChart('["bg-custom-500", "bg-green-500"]');
     this._githubmMonthAreaChart('["bg-orange-500"]');
     this._githubmYearAreaChart('["bg-custom-500"]');
     this._stackedAreaChart('["bg-custom-500", "bg-yellow-500", "bg-slate-200"]');
     this._irregularTimeseriesChart('["bg-custom-500", "bg-purple-500", "bg-green-500"]');
     this._nullValuesAreaChart('["bg-custom-500"]');
   }
