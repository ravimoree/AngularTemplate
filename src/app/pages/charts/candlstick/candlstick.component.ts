...
@Component({
  selector: 'app-candlstick',
  standalone: true,
  imports: [CommonModule,PageTitleComponent,NgApexchartsModule],
  templateUrl: './candlstick.component.html',
  styles: ``
})
export class CandlstickComponent {
  ...
  ngOnInit(): void {
    ...
    this._basicCandlestickChart('["bg-green-500", "bg-red-500"]');
    this._chartCandleOptions('["bg-sky-500", "bg-orange-500"]');
    this._chartBarOptions('["bg-yellow-500", "bg-red-500"]');
    this._categoryXAxisChart('["bg-green-500", "bg-red-500", "bg-sky-500"]');
    this._candlestickLineChart('["bg-green-500", "bg-red-500"]');
  }
