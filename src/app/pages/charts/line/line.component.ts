...
export class LineComponent {
  ...
  ngOnInit(): void {
    ...
    this._basicLineChart('["bg-custom-500"]');
    this._zoomableTimeseriesChart('["bg-custom-500"]');
    this._lineWithDataLabelsChart('["bg-custom-500", "bg-green-500"]');
    this._dashedLineChart('["bg-custom-500", "bg-orange-500", "bg-green-500"]');
    this._lineAnnotationsChart('["bg-custom-500"]');
    this._brushLineChart('["bg-slate-600"]');
    this._brushAreaChart('["bg-custom-500"]');
    this._stepLineChart('["bg-yellow-500"]');
    this._gradientChart('["bg-purple-500"]');
    this._missingDataChart('["bg-green-500", "bg-sky-500", "bg-yellow-500"]');
  }
